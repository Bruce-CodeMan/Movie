...
func (this *MainController) Get() {
	...
	//获取正在热播，调用接口
	hotVideos := models.GetHotList(1)
	this.Data["hotVideos"] = hotVideos
	//获取电视剧推荐、电影推荐，调用接口
	episodesVideos := models.GetEpisodesRecommend(1)
	moviesVideos := models.GetMoviesRecommend(3)
	this.Data["episodesVideos"] = episodesVideos
	this.Data["moviesVideos"] = moviesVideos
	//获取少女推荐，调用接口
